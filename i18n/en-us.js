export default {
    ...
    not_autoconfirmed_user: "You are not an autoconfirmed user",
    ...
    editconflict:
        "Edit Conflict! Don't panic. Please check the difference between your content below and the existing revision, then refresh the page to make another submit",
    ...
    mustbeposted: "The edit must be submitted by POST method",
    ...
    nosuchrevid: "Not an available reversion ID",
    badmd5: "Invalid MD5",
    ...
    redirect_appendonly:
        "Only append/prepend can be made to this page because of the rules of the redirect page",
    ...
    need_init:
        "Wikiplus haven't been loaded completely. It's a rare occasion so you can try to refresh and try again.",
    ...
    install_tip:
        "Do you allow Wikiplus to collect insensitive data to help us develop Wikiplus and provide feedback to current site: $1 ?",
    accept: "Yes",
    decline: "No",
    ...
    wikiplus_settings_placeholder:
        "Your setting is empty, please modify your setting according to the documentation.",
    ...
    history_edit_warning:
        " // You are trying to edit a history revision of this page. This will apply to the latest revision. Please be careful.",
    create_page_tip:
        "<!-- You are now creating a new page. Please delete this line and be careful. -->",
    continue: "Continue anyway",
    default_summary_suffix: "// Edit via Wikiplus",
    cross_page_history_revision_edit_warning:
        "Temporarily does not support cross-page editing of historical versions.",
};
